...
import info.dvkr.screenstream.ui.tabs.settings.app.settings.general.StartOnBoot
...
public data object GeneralGroup : ModuleSettings.Group {
    ...
    override val items: List<ModuleSettings.Item> =
        listOf(AppLocale, NightMode, DynamicTheme, Notifications, Tile, StartOnBoot, Logging)
