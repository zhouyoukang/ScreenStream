...
| 系统 | 位置 | AGENTS.md |
|------|------|-----------|
| 远程桌面Agent | `远程桌面/` | `远程桌面/AGENTS.md` |
| 远程中枢 | `远程桌面/remote-hub/` | `远程桌面/AGENTS.md` |
| AGI仪表盘 | `AGI/` | `AGI/AGENTS.md` |
| VPN管理 | `clash-agent/` | `clash-agent/AGENTS.md` |
| 智能家居 | `智能家居/` | `智能家居/AGENTS.md` |
| 认知代理 | `认知代理/` | `认知代理/AGENTS.md` |
| 手机操控 | `手机操控库/` | `手机操控库/AGENTS.md` |
| 公网投屏 | `公网投屏/cast/` | — |
| 三界隔离 | `构建部署/三界隔离/` | `构建部署/三界隔离/AGENTS.md` |
| 桌面守护 | `远程桌面/` | `远程桌面/AGENTS.md` |
| 双电脑互联 | `远程桌面/rdp/` | `文档/双电脑连接卡.md` |
| Voxta对话 | `VAM-agent/voxta/` | `VAM-agent/AGENTS.md` |
