...
1. 设置环境变量并编译：
```powershell
$env:JAVA_HOME = "C:\Program Files\Android\Android Studio\jbr"; $env:ANDROID_SDK_ROOT = "090-构建与部署_Build\android-sdk"; & ".\gradlew.bat" assembleFDroidDebug --no-configuration-cache 2>&1 | Select-Object -Last 20
```
2. 如果编译失败：
   - 读取错误信息
   - 修复代码
...
// turbo
```powershell
& "090-构建与部署_Build\api-verify.ps1"
```
4. 如果涉及新 API，手动追加验证：
```powershell
