...
> **最后更新**: 2026-03-20 (v17.0: 全层数字统一审计——32 Skills/12 Workflows/54 AGENT_GUIDE)
...
器 — 持久知识 (跨对话)
 ├── AGENT_GUIDE.md × 54          目录级参考指南(Agent按需read_file)
...
- **v17.0**: 全层数字统一审计(32 Skills/12 Workflows/54 AGENT_GUIDE) | kernel.md文档入口修复
...
### AGENT_GUIDE.md 清单（17个核心 + 37卫星 = 54总计）
...
> v17.0: Memory=0。知识归AGENT_GUIDE，行为归Skill。道法术三层自足，无需外部记忆。
...
- [ ] AGENT_GUIDE.md 54个文件存在 (`find_by_name(".", "*AGENT_GUIDE*", Extensions=["md"])`)
