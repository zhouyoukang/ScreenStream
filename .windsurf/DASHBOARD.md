...
> **最后更新**: 2026-03-20 (v17.2: 全层数字一致性修复——32 Skills/13 Workflows/60+ AGENT_GUIDE)
...
- Agent行为的最高指令
- **内容**：元规则 / 五感×器 / 八德 / 降级链L1-L4 / 本能层9条+终端安全4条 / 反者道之动
...
> 知识归AGENT_GUIDE，行为归Skill。道法术三层自足，无需外部记忆。
...
- [ ] Skills 每个目录均有 SKILL.md 且含 YAML frontmatter
- [ ] Workflows 每个 .md 文件均有 description
