...
**关键发现**：
- **搜索结果价≠真实最低价**：必须进入详情页翻查券/补贴/叠加优惠
- 同平台不同店铺价差巨大（淘宝：旗舰店¥150 vs 特价店¥91，差60元）
- 政府补贴15%是真实可用的大额优惠，部分店铺已含在标价中
- 天猫旗舰店详情页优惠叠加：券后¥150 + 学生减10 + 满200减25 + 限时补贴25 + 国补折上折 → 理论最低~¥115
- 得物详情页：品牌最低¥148，新人券-¥22=¥126，特定SKU¥113起
- 识货网(shihuo.cn)严选店铺价比APP直搜低10-20元
- **比价最优路径**：进详情页查券 > 识货网查底价 > 对应平台下单
- `adb shell input text` 只能输入ASCII，中文搜索需用 `clipboard_write` + 粘贴
- keyevent 279(粘贴)在部分APP不生效
- **京东WiFi ADB安全验证**：WiFi连接下京东完全锁死，USB连接时可用back绕过法
