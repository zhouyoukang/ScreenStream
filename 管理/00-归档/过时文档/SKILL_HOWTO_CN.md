...
- `docs/SKILLS.md`
- `.windsurf/skills/ (各子目录含 SKILL.md)`
...
- 你要做**证据收集 + 命令分组**：
  ...
  - 用 `.windsurf/skills/terminal-runbook/`
- 你要做**输入链路/端口/入口统一**：
  - 用 `.windsurf/skills/input-unify/`
  - 相关 ADR：`docs/adr/ADR-20260210-input-http-entrypoints.md`
- 你要做**Quest/上游差异合并与登记**：
  - 用 `.windsurf/skills/merge-plan/`
  - 清单：`docs/MERGE_ARCHIVE_CHECKLIST.md`
- 你要做**构建/发布/验收不漏项**：
  - 用 `.windsurf/skills/release-checklist/`

## 6) 如何从 0 搭建一个新 Skill（落地规则）

### 6.1 最小落地形态

- 新建目录：`.windsurf/skills/<skill-name>/`
- 新建文件：`SKILL.md`
...
- 选 skill：`.windsurf/skills/input-unify/`
- 证据包：
