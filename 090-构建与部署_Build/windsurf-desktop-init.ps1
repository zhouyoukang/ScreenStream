...
# 测试代理连通性
try {
    $null = Invoke-WebRequest "https://github.com" -Proxy "http://127.0.0.1:7897" -TimeoutSec 5 -UseBasicParsing -ErrorAction Stop
...
Test-Item "Git代理 ($gitProxy)" { $gitProxy } "运行: git config --global http.proxy http://127.0.0.1:7897"
